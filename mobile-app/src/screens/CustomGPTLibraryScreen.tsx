...
const styles = StyleSheet.create({
  ...
  publicTag: { fontSize: 10, color: colors.primary, borderColor: colors.primary, borderWidth: 1, paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: 10 },
